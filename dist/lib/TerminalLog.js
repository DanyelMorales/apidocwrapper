...
(function (TerminalLog) {
    function log(color, msg, debug = false) {
        if (debug) {
            console.log(color, msg, exports.tcolors.TP_ANSI_RESET);
        }
    }
    TerminalLog.log = log;
    ;
    function err(msg, debug = false) {
        log(exports.tcolors.TP_ANSI_FG_RED, msg, debug);
    }
    TerminalLog.err = err;
    ;
    function warn(msg, debug = false) {
        log(exports.tcolors.TP_ANSI_FG_YELLOW, msg, debug);
    }
    TerminalLog.warn = warn;
    ;
    function notice(msg, debug = false) {
        log(exports.tcolors.TP_ANSI_FG_BLUE, msg, debug);
    }
    TerminalLog.notice = notice;
    ;
    function success(msg, debug = false) {
        log(exports.tcolors.TP_ANSI_FG_CYAN, msg, debug);
    }
    TerminalLog.success = success;
    ;
